...
this;this._sessionid=void 0;a=this.url+"/"+a+"?libversion=4.1.0.0";this._socket=""==this.subprotocol?new WebSocket(a,"Json" , Global.CApem):new WebSocket(a,this.subprotocol , Global.CApem);this._onConnecting();this._socket.onopen=function(a){};this._socket.onmessage=function(a){a=b._decode(a.data);b._onMessage(a.toString())};this._socket.onclose=function(a){b._logger.debug("onclose: wasClean =",a.wasClean,", code=",a.code,", reason =",a.reason);b._isConnecting?b._onConnectFailed(a):(1006==a.code&&b._onTimeout(),b._onDisconnect())};
