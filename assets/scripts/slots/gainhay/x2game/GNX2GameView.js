...
(function () {
    cc.GNX2GameView = cc.Class({
        ...
        onLoad: function () {
            cc.GNX2GameController.getInstance().setX2GameView(this);
            this.spritePicks = [];
            var self = this;
        ...
        onEnable: function () {
            var baseValue = cc.GNX2GameController.getInstance().getBaseValue();
            var x2GameData = cc.GNX2GameController.getInstance().getX2GameData();
