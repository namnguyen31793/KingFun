...
(function () {
    cc.BacaratGroupUserView = cc.Class({
        ...
        properties: {
            groupUserListView: cc.DragonTigerGroupUserListView,
        },
        ...
        getGroupUser: function () {
            var getGroupUserCommand = new cc.DragonTigerGroupUserCommand;
        ...
        closeClicked: function () {
            ...
            cc.director.getScheduler().schedule(function () {
                self.animation.stop();
                cc.DragonTigerPopupController.getInstance().destroyGroupUserView();
            }, this, 1, 0, delay, false);
        },
    });
}).call(this);