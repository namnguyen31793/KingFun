...
(function () {
    cc.TaiXiuSieuTocResultEffectView = cc.Class({
        ...
        onLoad: function () {
            //setView
            cc.TaiXiuSieuTocController.getInstance().setTaiXiuSieuTocResultEffectView(this);
            //luu lai vi tri goc
        ...
        onDestroy: function () {
            cc.TaiXiuSieuTocController.getInstance().setTaiXiuSieuTocResultEffectView(null);
        },
        ...
        playEffectWin: function (amount) {
            ...
            if (cc.TaiXiuSieuTocController.getInstance().getBetSide() === cc.TaiXiuSieuTocBetSide.TAI) {
                //hien text
