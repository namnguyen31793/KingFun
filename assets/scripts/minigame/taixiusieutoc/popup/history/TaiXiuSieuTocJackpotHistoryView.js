...
cc.TaiXiuSieuTocJackpotHistoryView = cc.Class({
    ...
    getTopSessionWinners: function () {
        ...
        TXGetHistoryJackpotCommand.executeSieuToc(this);
    },
    ...
    closeClicked: function () {
        ...
        cc.director.getScheduler().schedule(function () {
            self.animation.stop();
            cc.TaiXiuSieuTocMainController.getInstance().destroyJackpotHistoryView();
        }, this, 1, 0, delay, false);
    },
    ...
    updatePage: function () {
        ...
        for (var i = 0; i < this.listItems.children.length; i++) {
            ...
            if (itemData) {
                node.active = true;
                var a = node.getComponent(cc.TaiXiuSieuTocJackpotHistoryItem);
