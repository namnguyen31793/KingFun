cc.Class({
    ...
    Show(slotControler){
        ...
        ApiController.RequestGetHistoryJackpot( Global.Enum.GAME_TYPE.CUNG_HY_PHAT_TAI, (data) => {
            //hideloading
    ...
    SetImageItem(id, itemView, loop = false) {
        var icons = require("CHPT_SpinController").getIns().mainView.spinController.getIconView().icons;
