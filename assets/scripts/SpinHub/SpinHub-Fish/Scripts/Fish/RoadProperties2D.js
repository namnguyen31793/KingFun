...
var PathProperties2D = require ("PathProperties2D");
var RoadProperties2D =  cc.Class({
    ...
    properties: {
		...
		numberOfPoint : 30,
		pathPropertiesList :[require ("PathProperties2D")],
		totalDuration:0.0,
		targetObject:null,
		idPathDebug:0,
   ...
   SetupRoad( vectorDireciton)
    {
        for(let i = 0;i< this.targetPointList.length - 1;i++)
        {
            ...
            let pathProperties = new PathProperties2D();
...
module.exports = RoadProperties2D;
