cc.Class({
    ...
    Show(slotControler){
        ...
        var self = this;
        //showloading
        ApiController.RequestGetHistoryJackpot( 37, (data) => {
            //hideloading
    ...
    SetImageItem(id, itemView, loop = false) {
        itemView.getComponent(this.slotControler.slotUI.nameClassItem).SetImageItem(id, this.slotControler.slotUI.itemImgData[id-1], 1);  
    },
