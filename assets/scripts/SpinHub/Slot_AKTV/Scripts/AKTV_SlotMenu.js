cc.Class({
    ...
    ClickShowSetting(){
        if(this.SettingPopup == null){
            ...
            let seft = this;
            // cc.loader.loadRes("Slot_AnKhe/prefabs/PopupSetting",
            ...
            //         seft.SettingPopup.getComponent(seft.NameSettignPopup).Init(seft.slotController);
    ...
    ClickShowHelp(){
        if(this.HelpPopup == null){
            //nếu effect chưa có thì load ra, xong rồi init event end anim
            let seft = this;
            // cc.loader.loadRes("Slot_AnKhe/prefabs/PopupGuide",
            //     function (completedCount, totalCount, item) {
            //     },
            //     function (err, prefab) {
            //         let effect = cc.instantiate(prefab);
    ...
    ClickShowRank(){
        if(this.RankPopup == null){
            //nếu effect chưa có thì load ra, xong rồi init event end anim
            let seft = this;
            // cc.loader.loadRes("Slot_AnKhe/prefabs/PopupRank",
            //     function (completedCount, totalCount, item) {
            //     },
            //     function (err, prefab) {
            //         let effect = cc.instantiate(prefab);
            //         seft.nodeParentPopup.addChild(effect);
            //         effect.setPosition(cc.v2(0,0));
            //         seft.RankPopup = effect.getComponent(seft.NameRankPopup);
    ...
    ClickShowHistory(){
        if(this.HistoryPopup == null){
            let seft = this;
            // cc.loader.loadRes("Slot_AnKhe/prefabs/PopupHistory",
            //     function (completedCount, totalCount, item) {
            //     },
            //     function (err, prefab) {
            //         let effect = cc.instantiate(prefab);
