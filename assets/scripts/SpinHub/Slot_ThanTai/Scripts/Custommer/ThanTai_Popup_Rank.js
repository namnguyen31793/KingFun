cc.Class({
    ...
    Show(slotControler){
        ...
        ApiController.RequestGetHistoryJackpot( Global.Enum.GAME_TYPE.THAN_TAI, (data) => {
            //hideloading
    ...
    SetImageItem(id, itemView, loop = false) {
        var icons = require("ThanTaiSpinController").getIns().mainView.spinController.getIconView().icons;
