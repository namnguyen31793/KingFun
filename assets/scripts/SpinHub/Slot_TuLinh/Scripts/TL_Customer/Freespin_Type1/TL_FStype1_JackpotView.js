...
cc.Class({
    ...
    Freespin_Type1_JackpotView_Setup(specialType)
    {
    ...
    UpdateJackpotValue(jackpotModel)
    {
        if(this.specialType.Input <= 3 )
        {
            this.OnlyOne_Jackpot_Lb.tweenValueto(jackpotModel.BetValue * jackpotModel.MinorJackpotMulti + jackpotModel.MinorJackpotValue);
        }
        else
        {
            this.OnlyOne_Jackpot_Lb.tweenValueto(jackpotModel.BetValue * jackpotModel.GrandJackpotMulti + jackpotModel.GrandJackpotValue);
        }
    },
